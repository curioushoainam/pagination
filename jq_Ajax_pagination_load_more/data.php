...
$conn = mysqli_connect('localhost', 'root', '', 'demo') or die ('Không thể kết nối đến CSDL');
...
// Ngược lại thì hiển thị bình thường. Trường hợp này dùng load trong file index.php
else 
{
    $total = count($result);
